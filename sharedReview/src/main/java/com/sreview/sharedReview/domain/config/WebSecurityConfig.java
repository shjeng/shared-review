package com.sreview.sharedReview.domain.config;

import com.sreview.sharedReview.domain.filter.JwtAuthenticationFilter;
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .sessionManagement(sessionManagement -> sessionManagement
                        ...
                        .requestMatchers(HttpMethod.GET,"/", "/api/auth/**", "/api/search/**", "/file/**","/api/board/**").permitAll()
